...
export const csAPI = {
  ...
  versions:       (id)        => api.get(`/cs/documents/${id}/versions`),
  getVersion:     (id, vid)   => api.get(`/cs/documents/${id}/versions/${vid}`),
  restoreVersion: (id, vid)   => api.post(`/cs/documents/${id}/versions/${vid}/restore`),
  clauses:        ()          => api.get('/cs/clauses'),
  createClause:   (data)      => api.post('/cs/clauses', data),
  updateClause:   (id, data)  => api.put(`/cs/clauses/${id}`, data),
  deleteClause:   (id)        => api.delete(`/cs/clauses/${id}`),
  bulkSend:       (data)      => api.post('/cs/bulk-send', data),
