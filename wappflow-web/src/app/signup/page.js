      ...
      <aside className="auth-promo">
        ...
        <div className="auth-promo-content">
          ...
          <h1 className="auth-promo-title">
            Stop losing leads on <span className="auth-grad">WhatsApp</span>.
          </h1>
          <p className="auth-promo-sub">
            Set up in under 5 minutes. Connect your number, invite your team, and let
            the AI score every conversation as it lands in your inbox.
          </p>
      ...
      <main className="auth-form-wrap">
        ...
        <div className="auth-form">
          <div className="auth-form-head">
            ...
            <p>Get the AI-powered WhatsApp CRM. Free to start.</p>
          </div>
  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .auth-google > div { width: 100% !important; max-width: 380px; }
